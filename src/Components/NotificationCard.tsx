...
export const NotificationCard = () => {
  return (
    <>
      {/* Notifications */}
      <div>
        <div className="flex gap-3 p-4 text-sm bg-very-ligth-graying-blue text-very-dark-blue cursor-pointer mb-1 rounded-lg">
        ...
        <div className="flex gap-3 p-4 text-sm text-very-dark-blue cursor-pointer mb-1 rounded-lg">
        ...
        <div className="flex gap-3 p-4 text-sm text-very-dark-blue cursor-pointer mb-1 rounded-lg">
          ...
          <img src={ImageGhess} alt="" className="w-10 h-10" />
        </div>
